  ...
  return (
    <section className="section-padding container-main border-t border-border-base">
      <div className="grid-12">
        <Reveal className="col-span-3 md:col-span-3" delay={0}>
          <p className="font-technical-sm text-text-muted uppercase tracking-technical">
            Public Access
          </p>
        </Reveal>

        <Reveal className="col-span-9 md:col-span-7 md:col-start-4" delay={0.1}>
          <p className="font-body-lg text-text-secondary leading-body max-w-2xl">
